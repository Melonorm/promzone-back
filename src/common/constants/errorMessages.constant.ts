...
export const EQUIPMENT_INSPECT_DATE_REDUNDANT_MESSAGE: string = 'Inspection date redundant for this equipment type.';

export const OPERATOR_ALREADY_EXIST_MESSAGE: string = 'Operator with this login already exist.';
export const OPERATOR_NOT_FOUND_MESSAGE: string = 'Operator not found.';
export const OPERATOR_WRONG_PASSWORD_MESSAGE: string = 'Wrong password.';

export const UNAUTHORIZED_MESSAGE: string = 'You are not authorized.';